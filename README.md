...
- 📤 **Export hub** — video (MP4/WebM, 720p–4K), audio (M4A/MP3/WAV), transcript (TXT/MD/DOCX/PDF, optional timestamps), subtitles (SRT/VTT/JSON), or NLE/DAW timeline (Resolve/Premiere/FCP/AAF/Reaper/Samplitude EDL)
